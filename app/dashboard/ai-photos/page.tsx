        ...
        <div className="space-y-6">
          ...
          <div className="space-y-3">
            ...
            <button
              ...
              className="w-full py-3 bg-primary/20 hover:bg-primary/30 text-primary rounded-xl font-semibold transition-all duration-200 flex items-center justify-center gap-3 disabled:opacity-50 disabled:cursor-not-allowed text-sm border border-primary/30"
            >
              {isEnhancing ? (
                <>
