              ...
              <div className="card p-6 hover:shadow-2xl transition-all duration-300 animate-scale-in" style={{ animationDelay: '100ms' }}>
                ...
                <div className="space-y-3">
                  <div className="flex items-start gap-3 p-3 bg-background-tertiary rounded-lg">
                    ...
                    <div>
                      <p className="font-medium text-foreground">Instagram Business/Creator Account</p>
                      <p className="text-sm text-foreground-secondary">Personal accounts are not supported</p>
                    </div>
                  </div>
                  <div className="flex items-start gap-3 p-3 bg-background-tertiary rounded-lg">
                    <div className="p-1.5 bg-primary/20 rounded-full mt-0.5">
                    ...
                    <div>
                      <p className="font-medium text-foreground">Connected Facebook Page</p>
                      <p className="text-sm text-foreground-secondary">Your Instagram must be linked to a Facebook Page</p>
                    </div>
                  </div>
                </div>
